...
module.exports.getComponentByTime = function(query, limit, callback){
    fis.db.find(db_component, "root", query, {"name":true, "updateAuthor":true, "updateStamp":true, "version":true}, {}, function(error, cursor){
        if(error){
            callback(error);
        }else{
...
module.exports.getComponentByDownloads = function(query, limit, callback){
    fis.db.find(db_component, "root", query, {"name":true, "totaldowns":true}, {}, function(error, cursor){
        if(error){
            callback(error);
        }else{
...
console.log(options);
    fis.db.find(db_component, "root", queryObj, options, {}, function(error, cursor){
        if(error){
            callback(error);
        }else if(!cursor){
